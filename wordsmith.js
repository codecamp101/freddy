...
const wordsmith = [
    ...
    {
       word:"MOSES",
       hint:"Parted the Red Sea with a staff",
       offset:[2,5]
    },
    {
        word: "JESUS",
        hint:"The king of kings,The Lord of lords",
        offset:[1,3,5]
    },
    {
        word:"EGYPTIANS",
        hint:"An ancient civilization that is located in North Africa",
        offset:[1,3,5,7,8]
    },
    {
        word:"ELASTIC",
        hint:"The property of a stretchy substance",
        offset:[2,4,6]
    },
    {
        word: "VANCE",
        hint: "United States vice-president",
        offset: [1,3,4]
    }
];
